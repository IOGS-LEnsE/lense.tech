...
<head>
	...
	.footer_exercices .copyright, .footer_exercices .copyright a{
		color:white;
	} 
	.header_exercices{
	}
...
<div id="page" class="hfeed site">
	...
	<header id="masthead" class="site-header clearfix <?php echo esc_attr( $header_class ); ?>">
		...
		<div id="header-text-nav-container" style="border:0px;" class="<?php echo ( get_theme_mod( 'spacious_one_line_menu_setting', 0 ) == 1 ) ? 'menu-one-line' : ''; ?>">
     ...
     return $current_taxo;
		...
		if ( ( '' != spacious_header_title() ) && ! ( is_front_page() ) && ( ! get_theme_mod( 'spacious_header_title_hide', 0 ) ) ) {
			if ( ! ( get_theme_mod( 'spacious_blog_slider', '0' ) != '1' && is_home() ) ) { ?>
				...
				<div class="header-post-title-container clearfix" style="background-color:#2453FF;margin-top:20px;">
					<div class="inner-wrap">
					
						<div class="post-title-wrapper" style="background-color:#2453FF;">
							<?php
							if ( '' != spacious_header_title() ) {
								...
								<?php else : ?>
									<div style="padding-right:10px;border-top:1px solid #2453FF; color:#2453FF; position:absolute; padding-left:100px; margin-top:-45px;font-size:0.8em;">Conception et Ingénierie Electronique<i style="padding-left:20px;">by Villou</i></div>
									<h1 class="header-post-title-class" style="background-color:#2453FF;">
									<div style="text-align:center;vertical-align:baseline;position:absolute;background-color:#2453FF;font-size:1.2em;color:white;padding:10px;margin-left:-40px;margin-right:30px;margin-top:-45px;"><img src="http://lense.institutoptique.fr/ressources/Images/elec_logo.png" style="background-color:#0A3250;width:90px;margin:0px;"/>	
									</div>
									
									<div style="padding-left: 100px;">
									<?php 
										if(is_archive()){
											echo 'Tous les exercices sur le thème : ';
											echo get_current_archive_taxonomy();
